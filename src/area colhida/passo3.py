...
arquivos_e_tabelas = [
    #Quantidade
    {"csv": "data/area colhida/passo1/area_colhida_municipios.csv",         "tabela": "Ipeadata.area_colhida_municipios",    "tipo": "municipio"},
    {"csv": "data/area colhida/passo2/area_colhida_brasil.csv",             "tabela": "Ipeadata.area_colhida_brasil",          "tipo": "brasil"},
    {"csv": "data/area colhida/passo2/area_colhida_regiao.csv",             "tabela": "Ipeadata.area_colhida_regioes",         "tipo": "regioes"},
    {"csv": "data/area colhida/passo2/area_colhida_estado.csv",             "tabela": "Ipeadata.area_colhida_estados",         "tipo": "estados"},
    {"csv": "data/area colhida/passo2/area_colhida_meso.csv",               "tabela": "Ipeadata.area_colhida_mesorregioes",    "tipo": "mesorregioes"},
    {"csv": "data/area colhida/passo2/area_colhida_micro.csv",              "tabela": "Ipeadata.area_colhida_microrregioes",   "tipo": "microrregioes"},
]
